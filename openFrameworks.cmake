...
set(OPENFRAMEWORKS_INCLUDE_DIRS
    "${OF_ROOT_DIR}/libs/openFrameworks"
    "${OF_ROOT_DIR}/libs/openFrameworks/3d"
    "${OF_ROOT_DIR}/libs/openFrameworks/app"
    "${OF_ROOT_DIR}/libs/openFrameworks/communication"
    "${OF_ROOT_DIR}/libs/openFrameworks/events"
    "${OF_ROOT_DIR}/libs/openFrameworks/gl"
    "${OF_ROOT_DIR}/libs/openFrameworks/graphics"
    "${OF_ROOT_DIR}/libs/openFrameworks/math"
    "${OF_ROOT_DIR}/libs/openFrameworks/sound"
    "${OF_ROOT_DIR}/libs/openFrameworks/types"
    "${OF_ROOT_DIR}/libs/openFrameworks/utils"
    "${OF_ROOT_DIR}/libs/openFrameworks/video"
    ...
    "${OF_ROOT_DIR}/libs/glfw/include"
    "${OF_ROOT_DIR}/libs/glfw/include/GLFW"

    "${OF_ROOT_DIR}/libs/kiss"
    "${OF_ROOT_DIR}/libs/kiss/include"
    "${OF_ROOT_DIR}/libs/kiss/src"

    "${OF_ROOT_DIR}/libs/tess2"
    "${OF_ROOT_DIR}/libs/tess2/include"

    "${OF_ROOT_DIR}/libs/poco"
    "${OF_ROOT_DIR}/libs/poco/include"
    "${OF_ROOT_DIR}/libs/poco/include/Poco"
    "${OF_ROOT_DIR}/libs/poco/include/Poco/Crypto"
    "${OF_ROOT_DIR}/libs/poco/include/Poco/Foundation"
    "${OF_ROOT_DIR}/libs/poco/include/Poco/Net"
    "${OF_ROOT_DIR}/libs/poco/include/Poco/Util"
    "${OF_ROOT_DIR}/libs/poco/include/Poco/XML"
    "${OF_ROOT_DIR}/libs/poco/include/Poco/JSON"
    "${OF_ROOT_DIR}/libs/poco/include/Poco/Zip"
...
if(CMAKE_SYSTEM MATCHES Linux)
    ...
    if(OF_STATIC)
      ...
      if(OPENFRAMEWORKS_LIBS MATCHES OPENFRAMEWORKS_LIBS-NOTFOUND)
